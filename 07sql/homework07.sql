...
-- 1. Create a view of all employees and their department; include the employee ID, name, email,
--hire date and department name. Then write SQL commands to do the following:
...
-- This query generates the following error: 'Cannot modify a column which maps to a non key-preserved table'.
--We cannot modify a columns which maps to a non key-preserved table.
...
INSERT INTO EmpDeptView VALUES (1000, 'Emmanuel', 'Boye', 'efb4', '15-FEB-1996', 'Payroll');
