...
public class HelloKVLite {
    ...
    public static void main(String[] args) {
        ...
        String keyString2 = "helloKey2", valueString2 = "MAMA MIA!";
        ...
        if (store.get(key2) == null) {
            System.out.println("Good, key 2 successfully deleted...");
        } else {
            System.out.println("Oops, key 2 not deleted...");
        }
