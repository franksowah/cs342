...
--create sequence to index movie table
CREATE SEQUENCE movie_sequence START WITH 1;	

--a. No you do not need an additional sequence for the performer relation primary key values.
--b. executing time might be a problem using sequences in a DDL file.
